...
public class ClassificationYellowActivity extends AppCompatActivity {
    ...
    private CircularImageView circularSprite;
    ...
    private void showCategory() {
        ...
        for (int i = 0; i < categoryList.length; i++) {
            ...
            //categoryButton[i].setGravity(Gravity.RIGHT | Gravity.CENTER_VERTICAL);
            //categoryButton[i].setPadding(0, 0, 0, 5);
            //categoryButton[i].setCompoundDrawablePadding(5);
            ...
            categoryButton[i].setBackgroundResource(R.drawable.category3);
    ...
    private void generateSprite() {
        ...
        imageFrame.setBackgroundResource(R.drawable.cutout3);
        ...
        circularSprite = new CircularImageView(this);
        circularSprite.setBorderColor(Color.GRAY);
        circularSprite.setBorderWidth(5);
        circularSprite.setImageBitmap(bitmap);
        imageFrame.addView(circularSprite);
        ...
        AnimationUtils.SineWaveTrajectory spriteTrajectory = new AnimationUtils.SineWaveTrajectory(imageFrame, deviceWidth, 3, AMPLITUDE, fp.leftMargin, 50);
        spriteTrajectory.setDuration(SPRITE_TIMER);
        imageFrame.startAnimation(spriteTrajectory);
    ...
    private void rightGuress(final View view) {
        int[] viewLocation = new int[2];
